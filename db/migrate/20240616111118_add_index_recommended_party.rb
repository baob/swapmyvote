class AddIndexRecommendedParty < ActiveRecord::Migration[5.2]
  def up
    ...
    # putting constituency/site first helps queries that are only on constituency and site, no need for another index
    # optimised for databse seeding. If this doesn't work for the website, consider adding an index rather than changing this one.
